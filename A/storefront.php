...
<html >
    <head>
  		<meta charset="UTF-8">
      <title>Gear Me Sports | Home</title>
...
<body>
  ...
  <a target="blank" class= "top" href="Map.html">
    Find a store
  <img src="img/location.png" alt="Location Icon"  style="width: 30px; height: 30px;" >
...
<h1 class="welcome">Welcome to Gear Me Sports!</h1>
<br/>
    <br/>
    <br/>
...
<!--I THINK THIS SHOULD GO ON CATALOG AND WE SHOULD CERATE SOME ADS OR SOMETHING FOR THE HOMEPAGE-->
     ...
     error_reporting (E_ALL ^ E_NOTICE);//my original php element hides type of error on error report
     	...
     	$sql = "SELECT * FROM GMS_FeaturedProducts";
